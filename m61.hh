...
/// metAlloc
///    Structure tracking metadata for each allocation.
struct metAlloc {
    size_t sz; // size of allocation
    bool allocated; // tracks if currently allocated
    bool everAllocated; // tracks if a memory location has ever been allocated
